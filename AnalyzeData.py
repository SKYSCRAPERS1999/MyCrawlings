...
# tf-idf for all
def output_tf_idf(data_dict_all, data_idf_dict_all):
    print("Top words in all documents")
...
# ### Top weibos
def output_hot_text(data, num=30):
...
def run():
    ...
    output_tf(data_dict_all)
    output_tf_idf(data_dict_all, data_idf_dict_all)
